...
public class BayarCash extends javax.swing.JFrame {
    PaymentGui pg;
    Payment p;
    Booking b;
    Cash c;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BayarCash.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
